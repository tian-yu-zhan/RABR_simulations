...
# setwd("~/code_SIM_sharing/simulation_continuous_endpoints/results/")
setwd("C:/Users/ZHANTX/Documents/TZ/collaborations/clinical studies/immunology/RZB HS/Cui2007/RAR_unweighted/code/code_SIM_sharing/simulation_continuous_endpoints/results/")
# setwd("~/RAR_un/results/")
